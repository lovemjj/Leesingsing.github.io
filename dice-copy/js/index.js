...
function dataOnmouseover (id) {
  if (dataId === '') {
    ...
    document.getElementById('pie-chart').style.fontWeight = '300'
    ...
    document.getElementById('day').style.fontWeight = '300'
    ...
    document.getElementById('month').style.fontWeight = '300'
...
function selectPieChartId (id) {
  ...
  document.getElementById('pie-chart-0').style.fontWeight = '300'
  ...
  document.getElementById('pie-chart-1').style.fontWeight = '300'
  ...
  document.getElementById('pie-chart-2').style.fontWeight = '300'
  ...
  document.getElementById('pie-chart-3').style.fontWeight = '300'
